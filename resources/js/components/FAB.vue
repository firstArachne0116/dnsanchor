<template>
    <div
            :id="position + '-wrapper'" class="fab-wrapper" v-on-clickaway="away"
                        ...
                        >
                            <template v-if="action.tooltip">
                                <li
                                        ...
                                        data-toggle="tooltip" data-placement="left" data-html="true" :title="action.tooltip"
                                        @click="toParent(action.name)" class="pointer"
                                        ref="actions">
                                    <i style="font-size:25px;color:#fff;" :class="[ actionIconSize , action.icon]"></i>
                                </li>
                            </template>
                            <template v-else>
                                <li
                                        v-if="toggle" :style="{ 'background-color': action.color || bgColor }"
                                        @click="toParent(action.name)" class="pointer">
                                    <i style="font-size:36px;color:#fff;" :class="[ actionIconSize ,action.icon]"></i>
        ...
        <template v-if="rippleShow">
            <template v-if="mainTooltip">
                <div
                        v-ripple="rippleColor == 'light' ? 'rgba(255, 255, 255, 0.35)' : ''" @click="toggle = !toggle"
            ...
            <template v-else>
                <div
                        ...
                        class="fab-main pointer" :style="{ 'background-color': bgColor, 'padding': paddingAmount }"
                >
                    <i v-if="!toggle" :class="[ mainIconSize , { rotate: toggle && allowRotation }, 'flaticon-grid-menu main']"></i>
                    <i v-if="toggle" :class="[ mainIconSize , { rotate: toggle && allowRotation }, 'flaticon2-add-1 close']"></i>
                </div>
            </template>
        </template>
        <template v-else>
