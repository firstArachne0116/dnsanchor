...
return [
    ...
    'cleanup_failed_subject' => 'Oprydning af Controller-Backups for :application_name fejlede.',
    'cleanup_failed_body' => 'Der skete en fejl under oprydning af Controller-Backups for :application_name',

    'cleanup_successful_subject' => 'Oprydning af Controller-Backups for :application_name gennemført',
    'cleanup_successful_subject_title' => 'Backup oprydning gennemført!',
    'cleanup_successful_body' => 'Oprydningen af Controller-Backups for :application_name på disken :disk_name er gennemført.',

    'healthy_backup_found_subject' => 'Alle Controller-Backups for :application_name på disken :disk_name er OK',
    'healthy_backup_found_subject_title' => 'Alle Controller-Backups for :application_name er OK',
    'healthy_backup_found_body' => 'Alle Controller-Backups for :application_name er ok. Godt gået!',
    ...
    'unhealthy_backup_found_empty' => 'Denne applikation har ingen Controller-Backups overhovedet.',
