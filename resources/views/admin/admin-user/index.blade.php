                            ...
                            <div class="kt-portlet kt-portlet--tabs kt-portlet--height-fluid mb-3 ml-0 mr-0 mt-0 shadow-none bg-transparent">
                                <div class="kt-portlet__head p-0">
                                    ...
                                    <div class="kt-portlet__head-toolbar">
                                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-brand" admin-user="tablist">
                                            <li class="nav-item">
                                                <a @click.prevent="setTab( 'resource-create' )" :class="{ 'active' : isTabShowing( 'resource-create' ) }" class="nav-link" href="#" admin-user="tab">
                                                    Create New User
                                                </a>
                                            </li>
                                            <li class="nav-item ml-3">
                                                <a @click.prevent="setTab( 'resource-index' )" :class="{ 'active' : isTabShowing( 'resource-index' ) }" class="nav-link" href="#" admin-user="tab">
                                                    Dashboard
                                                </a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <table class="kt-datatable__table">
                                                        ...
                                                        <tbody class="kt-datatable__body">
                                                            <tr class="kt-datatable__row" v-for="(item, index) in collection">
                                                                ...
                                                                <td class="kt-datatable__cell">
                                                                    <editable :on-update="$parent.updateRecord" :record-url="item.resource_url" record-name="first_name" :text="item.first_name"></editable>
                                                                </td>

                                                                <td class="kt-datatable__cell">
                                                                    <editable :on-update="$parent.updateRecord" :record-url="item.resource_url" record-name="last_name" :text="item.last_name"></editable>
                                                                </td>

                                                                <td class="kt-datatable__cell">
                                                                    <editable :on-update="$parent.updateRecord" :record-url="item.resource_url" record-name="email" :text="item.email"></editable>
                                                                </td>
                        ...
                        <div class="col">
                            <div class="kt-subheader w-100 m-0 p-0 kt-grid__item mb-3" id="kt_subheader">
                                <div class="kt-subheader__main">
                                    ...
                                    <button @click.prevent="fabActionSave" type="button" class="ml-2 btn btn-sm btn-brand btn-upper">
