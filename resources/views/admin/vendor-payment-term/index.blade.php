    ...
    <div>
        <div v-cloak>
                                                ...
                                                <table class="kt-datatable__table">
                                                    <thead class="kt-datatable__head">
                                                        <tr class="kt-datatable__row">
                                                            <th is='sortable' :column="'id'" class="kt-datatable__cell kt-datatable__cell--sort"><span>Payment Term ID</span></th>
            ...
            <div v-if="isTabShowing( 'resource-create' )">
                ...
                <div class="row">
                    <div class="col mt-0">
                        <vendor-payment-term-form
                                ref="resource_create"
                                :action="'{{ url('admin/vendor-payment-terms') }}'"
                                inline-template>
                            ...
                            <form ref="form" class="form-horizontal form-create kt-form" method="post" @submit.prevent="onSubmit" :action="this.action" novalidate>
                                ...
                                @include('admin.vendor-payment-term.components.form-elements')
                            </form>
