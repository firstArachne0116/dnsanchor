                                                                                        ...
                                                                                        <table class="kt-datatable__table">
                                                                                            <thead class="kt-datatable__head">
                                                                                                <tr class="kt-datatable__row">
                                                                                                    <th is='sortable' :column="'created_at'" class="kt-datatable__cell kt-datatable__cell--sort">
                                                                                                        <span>Set On</span>
                                                                                                    </th>
                                                                                                    <th is='sortable' :column="'description'" class="kt-datatable__cell kt-datatable__cell--sort">
                                                                                                        <span>Task</span>
                                                                                                    </th>
                                                                                                    <th class="kt-datatable__cell kt-datatable__cell--sort">
                                                                                                        <span>Project/Contact</span>
                                                                                                    </th>
                                                                                                    <th is='sortable' :column="'due_at'" class="kt-datatable__cell kt-datatable__cell--sort">
                                                                                                        <span>Due Date</span>
                                                                                                    </th>
        ...
        <span v-if="pagination.current_page === pagination.last_page || pagination.last_page === 0" class="kt-datatable__pager-link kt-datatable__pager-link--next">
                                                                    <i class="flaticon2-next"></i>
                                                                                    ...
                                                                                    <div class="no-items-found text-center pt-3 pb-5" v-if="!collection.length > 0">
                                                                                        ...
                                                                                        <a class="btn btn-primary btn-spinner mt-3" href="#" @click.prevent="$parent.setTab( 'resource-create' )" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.task.actions.create') }}
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
