...
<div class="form-group row ">
    ...
    <div class="col-md-10">
            <div v-for="permission in form.permissions" :key="permission.id">
                <input type="checkbox" class="custom-control-input" v-model="form.permission_ids" :id="'permission' + permission.id" :value="permission.id">
                <label class="col-form-label" :for="'permission' + permission.id">@{{ permission.name }}</label>
            </div>
    </div>
</div>
