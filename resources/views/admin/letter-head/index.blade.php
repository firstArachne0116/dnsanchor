                                            ...
                                            <div class="kt-portlet mt-2">
                                                <div class="kt-portlet__body kt-portlet__body--fit">
                                                    ...
                                                    <div class="no-items-found text-center pt-3 pb-5" v-if="!collection.length > 0">
                                                        ...
                                                        <a class="btn btn-primary btn-spinner mt-3" href="#" @click.prevent="$parent.setTab( 'resource-create' )" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.letter-head.actions.create') }}
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
