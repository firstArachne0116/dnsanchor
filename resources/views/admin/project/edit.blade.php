            ...
            <div>
                    ...
                    <div class="kt-container ">
                        <div class="kt-subheader__main mt-3">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <span class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">{{ $project->title }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="kt-container  kt-grid__item kt-grid__item--fluid">
                                ...
                                <ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a @click="setTab('rfq')" class="nav-link " data-toggle="tab" href="#gpsd_rfq" role="tab">
                                            ...
                                            <span v-if="form.status === 'AWAITING_MANAGER_APPROVAL' && form.template_type === 'RFQ'" class="ml-3 btn btn-label-brand btn-sm btn-bold btn-upper">Awaiting Approval</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a @click="setTab('pcq')" class="nav-link" data-toggle="tab" href="#gpsd_pcq" role="tab">
                                            <i class="flaticon2-notepad"></i> PCQ
                                            <span v-if="form.status === 'AWAITING_MANAGER_APPROVAL' && form.template_type === 'PCQ'" class="ml-3 btn btn-label-brand btn-sm btn-bold btn-upper">Awaiting Approval</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a @click="setTab('fcq')" class="nav-link " data-toggle="tab" href="#gpsd_fcq" role="tab">
                                            <i class="flaticon2-notepad"></i> FCQ
                                            <span v-if="form.status === 'AWAITING_MANAGER_APPROVAL' && form.template_type === 'FCQ'" class="ml-3 btn btn-label-brand btn-sm btn-bold btn-upper">Awaiting Approval</span>
                                            <span v-else-if="fcq_signed" class="ml-3 btn btn-label-success btn-sm btn-bold btn-upper">Signed</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a @click="setTab('jcp')" class="nav-link " data-toggle="tab" href="#gpsd_jcp" role="tab">
                                            <i class="flaticon2-checking"></i> JCP
                                            <span v-if="form.status === 'AWAITING_MANAGER_APPROVAL' && form.template_type === 'JCP'" class="ml-3 btn btn-label-brand btn-sm btn-bold btn-upper">Awaiting Approval</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a @click="setTab('po')" class="nav-link " data-toggle="tab" href="#gpsd_po" role="tab">
                                            <i class="flaticon2-pie-chart"></i> PO
                                            <span v-if="form.status === 'AWAITING_MANAGER_APPROVAL' && form.template_type === 'PO'" class="ml-3 btn btn-label-brand btn-sm btn-bold btn-upper">Awaiting Approval</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a @click="setTab('misc_po')" class="nav-link " data-toggle="tab" href="#gpsd_misc_po" role="tab">
                                            <i class="flaticon2-pie-chart-1"></i> Misc PO
                                            <span v-if="form.status === 'AWAITING_MANAGER_APPROVAL' && form.template_type === 'Misc PO'" class="ml-3 btn btn-label-brand btn-sm btn-bold btn-upper">Awaiting Approval</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a @click="setTab('aa')" class="nav-link " data-toggle="tab" href="#gpsd_aa" role="tab">
                                            <i class="flaticon2-analytics-2"></i> AA
                                            <span v-if="form.status === 'AWAITING_MANAGER_APPROVAL' && form.template_type === 'AA'" class="ml-3 btn btn-label-brand btn-sm btn-bold btn-upper">Awaiting Approval</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a @click="setTab('jcw')" class="nav-link " data-toggle="tab" href="#gpsd_jcw" role="tab">
                                            <i class="flaticon2-pie-chart-2"></i> JCW
                                            <span v-if="form.status === 'AWAITING_MANAGER_APPROVAL' && form.template_type === 'JCW'" class="ml-3 btn btn-label-brand btn-sm btn-bold btn-upper">Awaiting Approval</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="tab-content">
                        @hasrole( 'Manager' )
                        <div v-if="awaitingManagerApproval" class="alert alert-info">
                            {{ trans('admin.project.awaiting_approval', [ 'requester' => $project->requester ? $project->requester->full_name : false, 'templateType' => $project->template_type ] ) }}

                            <div class="mt-3">
                                <button @click.prevent="openModal('reject-version')" class="btn btn-danger">Reject</button>
                                <button @click.prevent="openModal('approve-version')" class="btn btn-primary">Approve</button>
                            </div>
                        </div>
                        @else
                            <div v-if="awaitingManagerApproval" class="alert alert-warning">
                                This project is awaiting approval from a manager.
                            </div>
                        @endhasrole
                                ...
                                <div class="col-9">
                                    <div v-cloak v-show="isCurrentTab( ['po'] ) && fcq_signed || isCurrentTab(['pcq', 'fcq', ])" data-ktportlet="true" id="pcq_information">
                                        <project-invoice-listing
                                                :data="{{ $invoices->toJson() }}"
                                                :url="'{{ url('admin/projects/' . $project->id . '/lines') }}'"
                                ...
                                <div class="kt-portlet__body">
                                    <div class="kt-sc__title text-center">
                                        ...
                                        <div class="kt-form__actions mt-5">
                                            <button @click.prevent="fcq_signed = true" :disabled="!fcq_signed_at" class="btn btn-lg btn-brand mr-5">Yes, all is OK</button>
                                        ...
                                        <div class="kt-grid kt-grid--desktop kt-grid--ver-desktop  kt-todo" id="kt_todo">
                                            ...
                                            <div class="kt-grid__item kt-grid__item--fluid kt-todo__content" id="kt_todo_content">
                                                    ...
                                                    <div class="kt-portlet">
                                                        ...
                                                        <div class="kt-todo__header">
                                                            ...
                                                            <div class="kt-todo__nav">
                                                                <a href="#" class="kt-todo__link ">Main</a>

                                                                <a href="#" class="kt-todo__link ">Housekeeping</a>
                                                            </div>
                                                            <!--End:: Tasks Nav-->
                                                ...
                                                <div class="kt-todo__bottom">
                                                    <!--Begin::Section-->
                                                    <div class="row">
                                                        <div v-for="media in form.jcp_supporting_files" class="col-xl-3 col-lg-6 col-md-6">
                                                            <!--Begin::Portlet-->
                                                            <div class="kt-portlet">
                                ...
                                <div class="kt-portlet__body">
                                    <div class="kt-portlet__content">
                                        <div class="row">
                                            ...
                                            <!-- Quantity -->
                                            <div class="form-group-last col-6">
                                                <label for="quantity">
                                                    FCQ Signed On:
                                                </label>
                        ...
                        <div id="gpsd_misc_po" class="tab-pane fade">
                            <div class="row">
                                <div class="col-12">
                                    <a v-if="!editing_misc_po" @click.prevent="editing_misc_po = true" class="btn btn-label-brand btn-bold mb-3">Add New</a>
