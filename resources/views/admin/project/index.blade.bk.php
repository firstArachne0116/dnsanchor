...
@section('body')
                                    ...
                                    <table class="kt-datatable__table">
                                        ...
                                        <tbody class="kt-datatable__body">
                                            <tr class="kt-datatable__row" v-for="(item, index) in collection">
                                                ...
                                                <td class="kt-datatable__cell">@{{ item.client.primary_contact_name || '-' }}</td>
                                                <td class="kt-datatable__cell">@{{ item.client.company_name || '-' }}</td>
                                                <td class="kt-datatable__cell">@{{ item.client.company_phone || '-' }}</td>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    ...
    <a class="dropdown-item" @click.prevent="deleteItem(item.resource_url)" href="#">Delete</a>
  </div>
</div>
                                            </span>
