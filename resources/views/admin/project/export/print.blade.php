...
*/
    ...
    *, ::after, ::before {
    ...
    <div class="container">
        ...
        <table class="mt-4 mb-4" width="100%">
            <tr>
                <td width="50%">
                    ...
                    <table width="100%">
                        @foreach( $project->fields['figure']['materials'] as $key => $material )
                            <tr>
                                <td width="15%" class="font-weight-bold">{{ $key  }}</td>
                ...
                <td width="50%">
                    ...
                    <table width="100%">
                        @foreach( $project->fields['figure']['specs'] as $key => $specification )
                            <tr>
                                <td width="15%" class="font-weight-bold">{{ $key  }}:</td>
                                <td width="85%">{{ $specification }}</td>
                            </tr>
                        @endforeach
                    </table>
                </td>
        ...
        <div class="row">
            <div class="col-12">
                <h5 class="font-weight-bolder">Prices:</h5>
                <table class="table table-bordered" width="100%">
                    @foreach ( $project->lines as $line )
                        <tr>
                            <td>
                                <p class="m-0"><strong>{{ $line->name }}</strong> - <strong>{{ $line->description }}</strong></p>
        ...
        <div class="row">
            <div class="col-12">
                <h5 class="font-weight-bolder underline">Extra Costs / Information Requests</h5>
                <p>{{ $project->information_requests }}</p>
            </div>
        </div>
