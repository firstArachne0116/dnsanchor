...
<div class="container">
    ...
    @endif
        ...
        <table class="mt-4 mb-4" width="100%">
            <tr>
                <td width="70%">
                    @if ( $project->vendor )
                        <p><strong>{{ $project->vendor->name }}</strong></p>
                        <p>
                            {{ $project->vendor->suite }}, {{ $project->vendor->billing_address_street }}
                            <br>{{ $project->vendor->billing_address_city }}, {{ $project->vendor->billing_address_country }}
                            <br>Tel: {{ $project->vendor->phone }}
                            <br>Fax: {{ $project->vendor->fax }}
                        </p>
                    @endif
                </td>
                <td width="30%">
        ...
        <div class="col-12">
            ...
            <table class="table table-bordered" width="100%">
                ...
                @foreach ( $project->lines as $line )
                    @php( $total_cost += $line->total_cost )
                    <tr>
                        <td>
    ...
    <div class="row">
        ...
        <table class="mt-4 mb-4" width="100%">
            <tr>
                <td width="40%">
                    <p style="display:block;height:100px;">Manager</p>
                    <hr>
                    <p>for <strong>{{ $project->title }}</strong></p>
                </td>
                <td width="20%"></td>
                <td width="40%">
                    <p style="display:block;height:100px;">I have read the entire Agreement
                                                           (comprised of the front and back of this
                                                           document) and I hereby accept the terms
                                                           and conditions of this agreement.</p>
                    <hr>
                    <p>for <strong>{{ $project->client->name }}</strong></p>
                </td>
            </tr>
        </table>
