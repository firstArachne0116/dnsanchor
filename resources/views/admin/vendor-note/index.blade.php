...
@section('title', trans('admin.customer-category.actions.index'))
        ...
        <div v-cloak>
                                                ...
                                                <table class="kt-datatable__table">
                                                    <thead class="kt-datatable__head">
                                                        <tr class="kt-datatable__row">
                                                            <th is='sortable' :column="'id'" class="kt-datatable__cell kt-datatable__cell--sort"><span>Vendor Note ID</span></th>
                                                            <th is='sortable' :column="'name'" class="kt-datatable__cell kt-datatable__cell--sort"><span>Name</span></th>
                                                            <th is='sortable' :column="'note'" class="kt-datatable__cell kt-datatable__cell--sort"><span>Description</span></th>
                                                    ...
                                                    <tbody class="kt-datatable__body">
                                                        <tr @click.prevent="$parent.viewRecord(item.resource_url)" style="height: 50px;" class="kt-datatable__row" v-for="(item, index) in collection">
                                                            ...
                                                            <td class="kt-datatable__cell">
                                                                <editable :on-update="$parent.updateRecord" :record-url="item.resource_url" record-name="note" :text="item.note"></editable>
                                                            </td>
            ...
            <span v-if="pagination.current_page === pagination.last_page || pagination.last_page === 0" class="kt-datatable__pager-link kt-datatable__pager-link--next">
                                            ...
                                            <div class="no-items-found text-center pt-3 pb-5" v-if="!collection.length > 0">
                                                ...
                                                <a class="btn btn-primary btn-spinner mt-3" href="#" @click.prevent="$parent.setTab( 'resource-create' )" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.customer-category.actions.create') }}
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col mt-0">
                        <vendor-note-form
                            ...
                            <form ref="form" class="form-horizontal form-create kt-form" method="post" @submit.prevent="onSubmit" :action="this.action" novalidate>
                                ...
                                @include('admin.vendor-note.components.form-elements')
                            </form>
