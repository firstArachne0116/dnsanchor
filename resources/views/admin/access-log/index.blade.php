                                                ...
                                                <table class="kt-datatable__table">
                                                    <thead class="kt-datatable__head">
                                                        <tr class="kt-datatable__row">
                                                            <th is='sortable' :column="'id'" class="kt-datatable__cell kt-datatable__cell--sort"><span>Log ID</span></th>
                                                            <th is='sortable' :column="'status'" class="kt-datatable__cell kt-datatable__cell--sort"><span>Status</span></th>
                                                            <th is='sortable' :column="'username'" class="kt-datatable__cell kt-datatable__cell--sort"><span>Username</span></th>
                                                            <th is='sortable' :column="'ip_address'" class="kt-datatable__cell kt-datatable__cell--sort"><span>IP</span></th>
                                                            <th is='sortable' :column="'user_agent'" class="kt-datatable__cell kt-datatable__cell--sort"><span>User Agent</span></th>
                                                            <th is='sortable' :column="'created_at'" class="kt-datatable__cell kt-datatable__cell--sort"><span>Recorded At</span></th>
                                                    ...
                                                    <tbody class="kt-datatable__body">
                                                        <tr @click.prevent="$parent.viewRecord(item.resource_url)" style="height: 50px;" class="kt-datatable__row" v-for="(item, index) in collection">
                                                            ...
                                                            <td class="kt-datatable__cell"><span :class="item.status === 'success' ? 'text-success' : 'text-danger'">@{{ item.status }}</span></td>
                                                            <td class="kt-datatable__cell"><span>@{{ item.username }}</span></td>
                                                            <td class="kt-datatable__cell"><span>@{{ item.ip_address }}</span></td>
                                                            <td class="kt-datatable__cell"><span style="">@{{ item.user_agent }}</span></td>
                                                            <td class="kt-datatable__cell"><span style="">@{{ item.created_at || 'Not Recorded' }}</span></td>
                    ...
                    <div class="col mt-0">
                        <contact-form
                            ...
                            <form ref="form" class="form-horizontal form-create kt-form" method="post" @submit.prevent="onSubmit" :action="this.action" novalidate>
                                ...
                                @include('admin.access-log.components.form-elements')
                            </form>
