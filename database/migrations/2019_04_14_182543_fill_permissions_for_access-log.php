...
class FillPermissionsForAccessLog extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAccessLog constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.access-log',
            'admin.access-log.index',
            'admin.access-log.create',
            'admin.access-log.show',
            'admin.access-log.edit',
            'admin.access-log.delete',
        ]);
