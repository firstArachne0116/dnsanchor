...
class FillPermissionsForLetterHead extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLetterHead constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.letter-head',
            'admin.letter-head.index',
            'admin.letter-head.create',
            'admin.letter-head.show',
            'admin.letter-head.edit',
            'admin.letter-head.delete',
        ]);
