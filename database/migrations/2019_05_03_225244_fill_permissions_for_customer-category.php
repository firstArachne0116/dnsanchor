...
class FillPermissionsForCustomerCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCustomerCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.customer-category',
            'admin.customer-category.index',
            'admin.customer-category.create',
            'admin.customer-category.show',
            'admin.customer-category.edit',
            'admin.customer-category.delete',
        ]);
