...
class FillPermissionsForVendorNote extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVendorNote constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vendor-note',
            'admin.vendor-note.index',
            'admin.vendor-note.create',
            'admin.vendor-note.show',
            'admin.vendor-note.edit',
            'admin.vendor-note.delete',
        ]);
