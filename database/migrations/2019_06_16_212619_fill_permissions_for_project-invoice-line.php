...
class FillPermissionsForProjectInvoiceLine extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectInvoiceLine constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.project-invoice-line',
            'admin.project-invoice-line.index',
            'admin.project-invoice-line.create',
            'admin.project-invoice-line.show',
            'admin.project-invoice-line.edit',
            'admin.project-invoice-line.delete',
        ]);
