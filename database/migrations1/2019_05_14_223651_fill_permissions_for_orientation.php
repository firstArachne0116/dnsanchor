...
class FillPermissionsForOrientation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForOrientation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.orientation',
            'admin.orientation.index',
            'admin.orientation.create',
            'admin.orientation.show',
            'admin.orientation.edit',
            'admin.orientation.delete',
        ]);
