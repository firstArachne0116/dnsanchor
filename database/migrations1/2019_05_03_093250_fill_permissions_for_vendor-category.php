...
class FillPermissionsForVendorCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVendorCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.vendor-category.show',
            'admin.vendor-category.edit',
            'admin.vendor-category.delete',
        ]);
