...
class FillPermissionsForProjectInvoice extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectInvoice constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.project-invoice.index',
            'admin.project-invoice.create',
            'admin.project-invoice.show',
            'admin.project-invoice.edit',
            'admin.project-invoice.delete',
        ]);
