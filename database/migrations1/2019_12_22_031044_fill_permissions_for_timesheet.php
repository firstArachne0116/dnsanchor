...
class FillPermissionsForTimesheet extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTimesheet constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.timesheet',
            'admin.timesheet.index',
            'admin.timesheet.create',
            'admin.timesheet.show',
            'admin.timesheet.edit',
            'admin.timesheet.delete',
        ]);
