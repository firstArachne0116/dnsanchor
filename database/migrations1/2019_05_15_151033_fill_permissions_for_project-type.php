...
class FillPermissionsForProjectType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.project-type',
            'admin.project-type.index',
            'admin.project-type.create',
            'admin.project-type.show',
            'admin.project-type.edit',
            'admin.project-type.delete',
        ]);
